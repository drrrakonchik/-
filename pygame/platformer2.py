...
restart_img = pygame.image.load('rst.png')
start_img = pygame.image.load('str.png')
exit_img = pygame.image.load('stp.png')
...
def main():
    ...
    pygame.display.set_caption("Under Sea Adventure") # Пишем в шапку
